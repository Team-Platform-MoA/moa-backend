...
## 출력 형식
다음 JSON 구조로 정확히 반환해주세요(모든 필드는 반드시 포함):
...
{{
  ...
  "actions": "오늘 하루를 마무리하며 시도해볼 수 있는 구체적인 자기돌봄 방법들을 제안합니다."
...
## ⚠️ actions 작성 규칙 (매우 중요)
- **줄글 형식**으로 자연스럽게 설명
- 구체적이고 실행 가능한 방법들을 포함
- 부양자의 현재 상태와 일정을 고려한 현실적인 제안
- 200-400자 정도의 적절한 길이로 작성
- 부드럽고 격려적인 톤으로 작성
- 각 활동의 목적과 효과를 간단히 설명
